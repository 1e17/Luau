...
function painter:MouseOnDrawing(Drawing)
    ...
    if (Drawing.Transparency == 1) and (Mouse.X >= Drawing.Position.X and Mouse.X <= Drawing.Position.X + Drawing.Size.X) and (Mouse.Y + 36 >= Drawing.Position.Y and Mouse.Y + 36 <= Drawing.Position.Y + Drawing.Size.Y) then 
        return true 
    end 
...
function painter:DrawingOnDrawing(Drawing1, Drawing)
    ...
    if (Drawing.Transparency == 1) and (Drawing1.Position.X >= Drawing.Position.X and Drawing1.Position.X <= Drawing.Position.X + Drawing.Size.X) and (Drawing1.Position.Y >= Drawing.Position.Y and Drawing1.Position.Y + Drawing1.Size.Y <= Drawing.Position.Y + Drawing.Size.Y) then 
        return true 
    end 
